...
///
/// This extension allows optional values to be compared using the less-than operator (`<`), provided that the wrapped type conforms to `Equatable` and `Comparable`.
...
extension Optional: @retroactive Comparable where Wrapped: Equatable & Comparable {
  ...
  /// their wrapped values are compared. An optional with a value is always greater than an optional without a value (nil).
  ///
  /// - Parameters:
