...
extension Sequence {
  ...
  /// Decomposes the sequence into the first element matching the given predicate and the rest of the
  /// elements.
  ///
  /// This method iterates through the sequence, finding the first element that satisfies the predicate and
  ...
  /// `Bool` value indicating whether the element should be selected as the first.
  ...
  ///
  /// This is a convenience method that provides the first element of the sequence and an array of the
  /// remaining elements.
  ...
  ///
  /// This method iterates through the sequence, accumulating elements that satisfy the predicate and
  /// separating them from the others.
  /// - Parameter predicate: A closure that takes an element of the sequence as its argument and returns a
  /// `Bool` value indicating whether the element should be included in the matching group.
  ...
  ///
  /// This method iterates through the sequence, accumulating elements that satisfy the predicate until a
  /// non-matching element is found. The remaining elements are returned as a separate array.
  /// - Parameter predicate: A closure that takes an element of the sequence as its argument and returns a
  /// `Bool` value indicating whether the element should be included in the accumulated group.
  /// - Returns: A tuple containing an array of accumulated matching elements and an array of the remaining
  /// elements.
  ...
  /// - Parameter predicate: A closure that takes an element of the sequence as its argument and returns a
  /// `Bool` value indicating whether the element matches the condition.
  ...
  ///
  /// This method iterates through the sequence, creating batches of elements. A new batch starts whenever
  /// the predicate dictates.
  /// - Parameter predicate: A closure that takes the current batch and the next element as its arguments and
  /// returns a Boolean value indicating whether the element should start a new batch.
  ...
  ///
  /// This method divides the sequence into batches, each containing a specified number of elements, except
